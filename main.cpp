...
void control()
{
	...
	else if (flag == 1 && (count1 == 60000))
		rocket_to_cam_pos();

	else if (flag == 1 && count1 >= 100000)
		rocket_in_motion();
}
...
for(i=195;i<=200;i++)
{
     if(count>=5)
	 {
        ...
        if(count>=150){
            ...
            glBegin(GL_POLYGON);
            glVertex2f(8.0+tx,250.0+tx);
            glVertex2f(0.0+tx,258.0+tx);
            glVertex2f(37.0+tx,290.0+tx);
            glVertex2f(18.0+tx,290.0+tx);
            glVertex2f(22.0+tx,293.0+tx);
            glVertex2f(36.0+tx,294.0+tx);
            glVertex2f(50.0+tx,309.0+tx);
            glVertex2f(60.0+tx,300.0+tx);
            glEnd();
            drawFilledCircle(25.0+tx,262.0+tx,10.0);
            drawFilledCircle(48.0+tx,285.0+tx,10.0);
            tx+=0.04;
            ...
            if(count>500){
        if(int(count/100)%4!=0){
        glColor3f(1.0,0.647,0.0);//satellite
        glBegin(GL_POLYGON);//core
            glVertex2f(237.5+yy,350.0-xx);
            glVertex2f(252.5+yy,350.0-xx);
            glVertex2f(252.5+yy,320.0-xx);
            glVertex2f(237.5+yy,320.0-xx);
        glEnd();
        glColor3f(1.0,1.0,1.0);
        glBegin(GL_POLYGON);//side-panels
            glVertex2f(237.5+yy,340.0-xx);
            glVertex2f(230+yy,340.0-xx);
            glVertex2f(230+yy,330.0-xx);
            glVertex2f(237.5+yy,330.0-xx);

            glVertex2f(262.5+yy,340.0-xx);
            glVertex2f(227.5+yy,340.0-xx);
            glVertex2f(227.5+yy,330.0-xx);
            glVertex2f(262.5+yy,330.0-xx);
            glEnd();
            if(xx>130){xx=130;yy=130;}
            else{
            xx+=0.1;
            yy+=0.1;}
            }
        ...
        glColor3f(1.0,0.647,0.0);//satellite
        glBegin(GL_POLYGON);//core
            glVertex2f(237.5,350.0);
            glVertex2f(252.5,350.0);
            glVertex2f(252.5,320.0);
            glVertex2f(237.5,320.0);
        glEnd();
        glColor3f(1.0,1.0,1.0);
        glBegin(GL_POLYGON);//side-panels
            glVertex2f(237.5,340.0);
            glVertex2f(230,340.0);
            glVertex2f(230,330.0);
            glVertex2f(237.5,330.0);

            glVertex2f(262.5,340.0);
            glVertex2f(227.5,340.0);
            glVertex2f(227.5,330.0);
            glVertex2f(262.5,330.0);
        glEnd();}
        }
...
void page()
{
	...
	drawstring(100, 400, "SATELLITE LAUNCHING SIMULATION");
	drawstring(100, 380, "NAME : ");
	drawstring(150, 360, "Aashima");
	drawstring(150, 340, "Jaskaran");
	drawstring(150, 320, "Harshita");
	...
	drawstring(100, 180, "Press S to Launch the satellite");
